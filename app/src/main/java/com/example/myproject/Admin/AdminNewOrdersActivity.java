...
import com.example.myproject.Model.AdminOrders;
...
public class AdminNewOrdersActivity extends AppCompatActivity {
    ...
    private DatabaseReference ordersRef,adminRef;
        ...
        FirebaseRecyclerAdapter<AdminOrders,AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, final int position, @NonNull final AdminOrders model) {
                        ...
                        holder.userTotalPrice.setText("Price: Rs. "+model.getTotalAmount());
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setTitle("Have you shipped these orders?");
    ...
    private void RemoveOrder(String orderID) {
        ...
        adminRef.child(orderID).removeValue();
